      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="col-span-1 px-7">
          <h1 className="font-bold text-2xl text-blue-600 uppercase mb-4 text-center">
            CÔNG TY TNHH Dịch vụ CÂY XANH VĨNH PHAN
          </h1>
          ...
          <div className="mb-4">
            ...
            <button className="btn1">Liên hệ : 0348216852</button>
          </div>
          <h1 className="text-center text-2xl font-medium text-gray-950 mb-4">
